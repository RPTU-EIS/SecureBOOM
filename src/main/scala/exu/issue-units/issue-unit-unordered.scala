...
class IssueUnitStatic(
  ...
  extends IssueUnit(params.numEntries, params.issueWidth, numWakeupPorts, numWakeupPorts, params.iqType, params.dispatchWidth)
	// Total number of wakeup ports is not passed here since this issue unit is not used in the design // added by mofadiheh for taint
{
  //-------------------------------------------------------------
  // Issue Table
