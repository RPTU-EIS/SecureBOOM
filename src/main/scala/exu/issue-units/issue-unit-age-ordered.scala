...
class IssueUnitCollapsing(
  params: IssueParams,
  numWakeupPorts: Int,
  numTotalWakeupPorts: Int) // added by mofadiheh for taint
  (implicit p: Parameters)
  extends IssueUnit(params.numEntries, params.issueWidth, numWakeupPorts, numTotalWakeupPorts, params.iqType, params.dispatchWidth) // modified by mofadiheh for taint
{
  //-------------------------------------------------------------
